...
std::ostream& operator<<(std::ostream& os, const AlignmentResult& result) {
    ...
    os << "Seq1:  " << std::setw(padding) << result.range1.first + 1 << "  " << result.aligned1 << "  " << result.range1.second + 1 << std::endl;
    os << "         " << std::string(padding, ' ') << result.alignment << std::endl;
    os << "Seq2:  " << std::setw(padding) << result.range2.first + 1 << "  " << result.aligned2 << "  " << result.range2.second + 1 << std::endl;
    return os;
}
